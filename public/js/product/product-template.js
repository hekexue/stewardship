	...
	return {
		...
		listView: function() {
			var list = [
				...
				'		<td data-bind="companyClass"><%=rcd.companyClass=="1"?"一类企业":rcd.companyClass =="2"?"二类企业":rcd.companyClass=="3"?"三类企业":"四类企业"%></td>',
				'		<td data-bind="riskLevel"><%=rcd.riskLevel==="High"?"高风险":rcd.riskLevel ==="LessHigh"?"较高风险":"一般风险"%></td>',
